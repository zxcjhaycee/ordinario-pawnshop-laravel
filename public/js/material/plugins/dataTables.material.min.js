...
(function(a){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(b){return a(b,window,document)}):"object"===typeof exports?module.exports=function(b,c){b||(b=window);c&&c.fn.dataTable||(c=require("datatables.net")(b,c).$);return a(c,b,b.document)}:a(jQuery,window,document)})(function(a,b,c,e){var d=a.fn.dataTable;a.extend(!0,d.defaults,{dom:"<'col-xl-12 row mobile_resize'<'mdl-cell mdl-cell--3-col dt-mobile_resize3'l><'mdl-cell mdl-cell--6-col dt-mobile_resize6'><'mdl-cell mdl-cell--3-col dt-mobile_resize3'f>><'mdl-grid dt-table'<'mdl-cell mdl-cell--12-col'tr>><'mdl-grid'<'mdl-cell mdl-cell--4-col dt-mobile_resize4'i><'mdl-cell mdl-cell--8-col dt-mobile_resize8'p>>",
renderer:"material"});a.extend(d.ext.classes,{sWrapper:"dataTables_wrapper form-inline dt-material",sFilterInput:"datatbl-search input-sm",sLengthSelect:"datatbl-length input-sm",sProcessing:"dataTables_processing panel panel-default"});d.ext.renderer.pageButton.material=function(b,l,w,x,m,r){var k=new d.Api(b),n=b.oLanguage.oPaginate,y=b.oLanguage.oAria.paginate||{},g,h,t=0,u=function(c,d){var e,l=function(b){b.preventDefault();a(b.currentTarget).hasClass("disabled")||k.page()==b.data.action||k.page(b.data.action).draw("page")};
