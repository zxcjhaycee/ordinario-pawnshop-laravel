                    ...
                    <div class="card">
                                  ...
                                  <div class="col-xl-6">
                                      ...
                                      <div class="col-xl-12 mt-4">
                                        <ul style="list-style-type:none;padding-left: 5px;">
                                            ...
                                            <li class="form-inline"><label class="font-weight-bold" style="display:inline-block;width:120px;text-align:right">Transaction Date </label> : <input type="text" class="form-control transaction_picker" style="margin-left:20px"  name="transaction_date" autocomplete="off"></li>
                        ...
                        <div class="card">
                                ...
                                <div class="row">
                                      ...
                                      <table class="table table-hover">
                                            ...
                                            <tbody>
                                                @foreach($inventory->item as $key => $value)
                                                    <tr onClick="toggleCheck(this)" data-appraised="{{ $value->item_type_appraised_value }}">
                                    ...
                                    <div class="col-xl-6">
                                    <h3 class="display-4">Interest</h3>
                                        <table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                    <th>Start Date</th>
                                    ...
                                    <h3 class="display-4">Computation</h3>
                                        ...
                                        <ul style="list-style-type:none;padding-left: 5px;">
                                            <li class="form-inline" style="height:40px;"><label class="font-weight-bold" style="display:inline-block;width:120px;text-align:right">Principal</label> : <input type="text" name="principal" class="form-control" style="margin-left:20px;width:200px" id="principal" value="{{ $inventory->principal }}" readonly></li>
