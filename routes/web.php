...
Route::middleware('auth')->group(function (){
    ...
    Route::prefix('pawn_auction')->group(function(){
        ...
        Route::get('inventory/renew/{ticket_id}/{id}', 'InventoryController@showUpdateRenew')->name('renew_update');
        ...
        Route::get('inventory/redeem/{ticket_id}/{id}', 'InventoryController@showUpdateRedeem')->name('redeem_update');
        ...
        Route::get('inventory/repawn/{ticket_id}/{id}', 'InventoryController@showUpdateRepawn')->name('repawn_update');
